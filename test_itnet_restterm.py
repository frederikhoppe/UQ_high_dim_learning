...
"""
This script applies a trained network to the estimation data and saves the reconstruction using the given It-Net. 
"""

path = "results/test_results_itnet_noisy_rest/"
path_model = "results/radial_220_unet_it8_noisy_train_phase_1/"
...
test_data = test_data("rest", **test_data_params)
